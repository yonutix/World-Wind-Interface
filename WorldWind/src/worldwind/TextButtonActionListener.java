...
/*
 * \class Action lsitener for "zoom" button
 */
class TextButtonActionListener implements ActionListener {
    ...
    TextButtonActionListener(WWJ parent,
            JTextField txtF,
            JComboBox jcb,
            JTextArea jta) {
        this.parent = parent;
